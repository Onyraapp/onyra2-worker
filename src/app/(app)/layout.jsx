...
function AppShell({ children }) {
  ...
  return (
    <div className="h-screen w-screen bg-bg flex flex-col max-w-lg mx-auto overflow-hidden relative">
        ...
        <div className="px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col justify-center">
              <Link href="/dashboard" className="font-neonize text-t1 tracking-tight text-sm leading-none mt-3" translate="no">Troco</Link>
